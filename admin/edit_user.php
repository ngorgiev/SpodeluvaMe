                ...
                <div class="col-lg-12">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <a id="user-id" class="btn btn-danger" href="delete_user.php?id=<?php echo $user->id; ?>">Избриши</a>
                                <input type="submit" name="update" class="btn btn-primary pull-right" value="Ажурирај">
                            </div>
                        </div>
                    </form>
